const translations = {
  ru: {
    ...
    productionTitle: 'Full Production', productionText: 'Полный цикл: идея, сценарий, съемка, DOP, монтаж, цвет, motion и финальная упаковка. Подходит для брендов, мастеров, студий, барбершопов, events и локального бизнеса.',
    ...
    interludeTattooTitle: 'Монтаж — это когда кадры начинают дышать как одна история.', interludeBarberTitle: 'Свет, зеркало и движение превращают услугу в атмосферу.', interludeReelTitle: 'Не просто портфолио — ощущение продакшна во время скролла.',
    ...
    proofFastTitle: 'Уровень виден сразу', proofFastText: 'Showreel и selected works быстро показывают стиль, ритм и качество картинки без долгих объяснений.',
    proofCycleTitle: 'Контент под задачу', proofCycleText: 'Не просто красивый ролик: съемка, монтаж, звук и цвет собираются под доверие, продажи и атмосферу бренда.',
    proofGeoTitle: 'Germany / remote', proofGeoText: 'Съемка по Германии, монтаж удаленно worldwide и понятная коммуникация от идеи до финального файла.',
  ...
  en: {
    ...
    productionTitle: 'Full Production', productionText: 'Full cycle: idea, script, shooting, DOP, editing, color, motion and final packaging. For brands, artists, studios, barbershops, events and local business.',
    ...
    interludeTattooTitle: 'Editing is when frames start breathing as one story.', interludeBarberTitle: 'Light, mirror and movement turn a service into atmosphere.', interludeReelTitle: 'Not just a portfolio — a production feeling while you scroll.',
    ...
    filterAll: 'All', filterEditing: 'Editing', filterProduction: 'Full production', filterTattoo: 'Tattoo', filterBeauty: 'Beauty', filterBusiness: 'Local business',
    proofFastTitle: 'The level is clear fast', proofFastText: 'The showreel and selected works reveal the style, rhythm and image quality without a long pitch.',
    proofCycleTitle: 'Content with a job to do', proofCycleText: 'Not just a beautiful clip: shooting, edit, sound and color are shaped for trust, sales and brand atmosphere.',
    proofGeoTitle: 'Germany / remote', proofGeoText: 'Shoots across Germany, remote editing worldwide and clear communication from idea to final file.',
  ...
  de: {
    ...
    productionTitle: 'Full Production', productionText: 'Full cycle: Idee, Script, Dreh, DOP, Schnitt, Color, Motion und finale Verpackung. Für Marken, Artists, Studios, Barbershops, Events und lokales Business.',
    ...
    interludeTattooTitle: 'Editing ist, wenn Frames als eine Geschichte zu atmen beginnen.', interludeBarberTitle: 'Licht, Spiegel und Bewegung machen aus Service Atmosphäre.', interludeReelTitle: 'Nicht nur Portfolio — ein Produktionsgefühl beim Scrollen.',
    ...
    filterAll: 'All', filterEditing: 'Editing', filterProduction: 'Full production', filterTattoo: 'Tattoo', filterBeauty: 'Beauty', filterBusiness: 'Local business',
    proofFastTitle: 'Das Level ist sofort klar', proofFastText: 'Showreel und Selected Works zeigen Stil, Rhythmus und Bildqualität ohne lange Erklärung.',
    proofCycleTitle: 'Content mit klarem Ziel', proofCycleText: 'Nicht nur ein schöner Clip: Dreh, Schnitt, Sound und Color arbeiten für Vertrauen, Verkauf und Markenatmosphäre.',
    proofGeoTitle: 'Germany / remote', proofGeoText: 'Drehs in Deutschland, Remote Editing worldwide und klare Kommunikation von der Idee bis zur finalen Datei.',
...
clipCards.forEach((card) => {
  ...
  card.setAttribute('aria-label', `${card.dataset.title || 'Portfolio video'}: open video`);
  video.pause();
  video.muted = true;
